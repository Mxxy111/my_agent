...
| Multi-source academic search and citation verification | `nature-academic-search`, `nature-citation` |
...
| PDFs and visual page checks | `pdf:pdf`, `nature-reader`, plus bundled `pypdf`, `pdfplumber`, Poppler when available |
...
| Data availability and FAIR metadata | `nature-data` |
...
| PowerPoint or defense deck | `presentations:Presentations`, `nature-paper2ppt` for paper-based academic decks |
...
| Reviewer response package | `nature-response` |
