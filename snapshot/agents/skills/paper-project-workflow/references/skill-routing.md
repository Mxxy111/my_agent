...
| Publication-grade Nature-style route | `nature-writing`, `nature-polishing` | paper-type archetype, reader contract, argument architecture, bounded claims |
...
| Source-grounded bilingual paper reading | `nature-reader` |
...
| Claim-to-citation mapping and strict support grading | `nature-citation`, `nature-academic-search` |
...
| AI-flavor diagnosis before rewriting | `anti-ai-flavor` |
| Humanize Chinese academic prose | `humanizer-zh`, `anti-ai-flavor` |
| Humanize English social-science writing | `humanize-academic-writing`, `anti-ai-flavor` |
| Nature-style scientific humanization or Chinese-to-English polish | `nature-polishing`, `nature-writing` |
| Remove AI-style traces from general text or markdown output | `anti-ai-flavor` |
| Evidence, citation, and claim-support audit | `nature-citation`, `academic-research-suite`, `nature-academic-search`, `scientific-writing` |
| Data, code, result, and figure accuracy audit | `code-review-and-quality`, `debugging-and-error-recovery`, relevant `ngs-analysis:*`, `data-analytics:*`, or life-science lookup skills |
...
| Figure contract, panel logic, export QA | `nature-figure` |
...
| PowerPoint/journal-club/defense deck from a paper | `nature-paper2ppt`, `presentations:Presentations`, `paper-deck` |
...
| Data availability, repository plan, FAIR metadata | `nature-data` |
| Reviewer response or revision package | `nature-response` |
...
7. For humanization, diagnose before rewriting and compare the revised text against the frozen draft for claim, citation, number, limitation, and disclosure drift.
8. For manuscript review, route accuracy checks to the most specific available skill: citation skills for references, data-analysis or bioinformatics skills for results, code-review skills for scripts/notebooks, and writing skills for argument clarity.
